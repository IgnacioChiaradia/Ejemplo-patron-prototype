...
public class TestHamburguesaFactory {
	...
	public void test_royal_si_cebolla() {
		...
		/**implementacion de patron prototype **/
		
		Hamburguesa royalSinCebolla = new HamburguesaFactory().clonarBurguer(HamburguesaFactory.royal())
				.removeExtra(Extra.CEBOLLA).crea();
